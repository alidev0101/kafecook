...
export const PAYMENT_STATUS = {
  unpaid: { label: "پرداخت نشده", color: "bg-red-100 text-red-700" },
...
export const SHIPPING_METHODS = [
  { value: "standard", label: "ارسال معمولی", desc: "۳ تا ۵ روز کاری", price: 35000 },
  { value: "express", label: "ارسال اکسپرس", desc: "۱ تا ۲ روز کاری", price: 70000 },
  { value: "pickup", label: "دریافت حضوری", desc: "مراجعه به فروشگاه", price: 0 },
];
